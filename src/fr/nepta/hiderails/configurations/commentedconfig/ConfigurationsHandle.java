...
public class ConfigurationsHandle
{
	...
	public void cloneConfig(String fileName, String existingResource) {
		File confF = new File(PLUGIN_PATH, fileName);
		File confFile = new File(PLUGIN_PATH, existingResource);
		...
		if (confFile.exists()) {
			...
			new Exception("The file " + fileName + " doesn't exist !");
		}
	}
	...
	/**
	 * Save commented configuration file
	 */
