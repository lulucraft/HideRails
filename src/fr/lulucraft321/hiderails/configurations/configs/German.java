...
public class German extends FileConfigurationManager implements AbstractLangConfig
{
	...
	public void setupConfig()
	{
		...
		if(!FileConfigurationManager.deLangFile.exists())
		{
			...
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "sender_type_error", "&cNur Spieler können diesen Command ausführen!");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "player_no_enough_permission", "&cDir fehlen die benötigten Rechte!");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "rail_success_change", "&2Du hast die Schienen durch %blocktype% ersetzt!");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "material_type_error", "&cDieser Block existiert nicht!");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "rail_error", "&cDer ausgewählte Block ist keine Schiene!");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "rail_success_break", "&2Du hast eine versteckte Schiene abgebaut!");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "rail_success_unhide", "&2Die Schienen sind nun wieder sichtbar!");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "water_protection_status_success_change", "&2Der unterwasser Schutz iwurde auf %status% in %world% geändert.");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "invalid_worldname", "&cDiese Welt existiert nicht!");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "plugin_success_reloaded", "&2Das Plugin wurde erfolgreich neugeladen.");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "water_protection_status_already", "&cDer unterwasser Schutz in %world% ist schon %status%");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "no_backup", "&cKein Backup verfügbar!");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "return_backup_success", "&2Das Backup wurde erfolgreich wiederhergestellt!");
			//FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "worldedit_not_installed", "&cWorldEdit ist nicht auf dem Server installiert!");
			//FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "worldedit_no_selection", "&cDu musst erst eine WorldEdit-Selektion machen!");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "hiderails_no_selection", "&cYou must first select region with wooden-axe!");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "hiderails_selection_pos", "&8You have selected position &e%pos%");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "selection_message_status", "&8You have &e%status% &8selection messages!");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "display_hidden_blocks", "&2Du hast die versteckten Schienen für dich %hide%!");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "invalid_player", "&cDieser Spieler existiert nicht!");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "update_found", "&bEine neue Version ist verfügbar: !\n&o%link%");
			FileConfigurationManager.deLangConfig.set(FileConfigurationManager.msgPath + "kick_spam_hidden_block", "&cDon't spam blocks please!!");
